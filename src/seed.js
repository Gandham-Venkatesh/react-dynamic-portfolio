...
const portfolioDataToUpload = {
  personalInfo: {
    ...
    loopingTexts: [
      "Tech Enthusiast", "AI Explorer", "Full Stack Developer", "Automation Builder",
      "Offline GPT Creator", "Python & React Dev", "TinyLLaMA Integrator",
      "Agentic AI Engineer", "LLM Tinkerer", "n8n Workflow Architect",
      "FastAPI Lover", "Creative Debugger", "Visionary Coder", "Open Source Contributor"
    ],
    profileImage: "/profile.jpg"
  },
  skills: [
    { category: "Languages", skills: [ { name: "JavaScript", level: 90 }, { name: "TypeScript", level: 85 }, { name: "Python", level: 88 }, { name: "Java", level: 82 }, { name: "C", level: 75 } ] },
    { category: "Frontend", skills: [ { name: "React", level: 92 }, { name: "HTML/CSS", level: 95 }, { name: "TailwindCSS", level: 88 }, { name: "JavaScript", level: 80 } ] },
    { category: "Backend", skills: [ { name: "Node.js", level: 87 }, { name: "Express.js", level: 85 }, { name: "Flask", level: 83 }, { name: "FastAPI", level: 80 } ] },
    { category: "AI/ML Tools", skills: [ { name: "TinyLLaMA", level: 85 }, { name: "scikit-learn", level: 82 }, { name: "LangChain", level: 78 }, { name: "llama.cpp", level: 80 } ] },
    { category: "Databases", skills: [ { name: "SQLite", level: 85 }, { name: "PostgreSQL", level: 70 } ] },
    { category: "Dev Tools", skills: [ { name: "Git/GitHub", level: 90 }, { name: "Docker", level: 78 }, { name: "VS Code", level: 95 }, { name: "Postman", level: 85 } ] }
  ],
  projects: [
    { id: "1", name: "Offline GPT", description: "Fully offline AI chatbot built using Android + Termux + TinyLLaMA, using FastAPI and llama.cpp for local inference.", link: "https://github.com/Gandham-Venkatesh/OfflineGPT-Android", tags: ["AI", "Android", "Python", "FastAPI"], visible: true },
    { id: "2", name: "CineRecommend", description: "Movie recommendation web app with React (TypeScript), Flask backend, JWT auth, and AI logic.", link: "https://github.com/Gandham-Venkatesh/CineRecommend-Full-Stack", tags: ["React", "Flask", "AI", "Full Stack"], visible: true },
    { id: "3", name: "Weather Forecast API", description: "Express.js REST API fetching live weather data using OpenWeatherMap.", link: "https://github.com/Gandham-Venkatesh/weather-api-node", tags: ["Node.js", "API", "Express"], visible: true },
    { id: "4", name: "Node CLI To-Do", description: "Command-line todo manager using Node.js, yargs, inquirer, and fs for persistent local storage.", link: "https://github.com/Gandham-Venkatesh/node-cli-todo", tags: ["Node.js", "CLI", "JavaScript"], visible: true },
    { id: "5", name: "Pokémon App", description: "Responsive React app using PokéAPI to search and display Pokémon data.", link: "https://github.com/Gandham-Venkatesh/pokemon-react-app", tags: ["React", "API", "JavaScript"], visible: true },
    { id: "6", name: "HardType", description: "Typing speed game using JavaScript that tracks real-time WPM and gives instant feedback.", link: "https://github.com/Gandham-Venkatesh/typing-tutor", tags: ["JavaScript", "Game", "Web"], visible: true }
  ],
  experiences: [
    {
      id: "exp1",
